...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-t from-black via-primary-dark to-primary-brown relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-12 mb-12">
            ...
            >
              <motion.h3
                className="text-4xl lg:text-5xl font-serif font-light text-white mb-6 tracking-wide"
              ...
              <motion.p
                className="text-gray-400 mb-8 leading-relaxed font-light text-lg"
              ...
              >
                {socialIcons.map((social, index) => (
                  <motion.a
                    key={social.name}
                    href="#"
                    className={`text-3xl text-gray-500 ${social.color} transition-all duration-300 relative group`}
                    whileHover={{
                      scale: 1.2,
                      y: -5,
            ...
            >
              ...
              >
                <motion.h4
                  className="text-white text-2xl font-serif font-light mb-6 tracking-wide"
