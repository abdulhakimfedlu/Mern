...
const FoodCategoryDashboard = () => {
    ...
    const handleOpenModal = (category = null) => {
        if (category) {
            ...
            setFormData({ name: category.name, image: null, imagePreview: category.image });
        } else {
    ...
    const handleSubmit = async (e) => {
        ...
        // If there's a new file, append it; otherwise send the existing image URL
        ...
        try {
            if (currentCategory) {
                const response = await api.put(`/categories/${currentCategory._id}`, formDataToSend, {
                    headers: {
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div className="flex gap-4 pt-6 border-t border-white/10 mt-6">
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 py-3 bg-gradient-to-r from-primary-gold to-yellow-600 text-primary-dark rounded-xl font-bold hover:shadow-lg hover:shadow-primary-gold/20 hover:scale-105 transition-all uppercase tracking-wider text-sm ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
                                    >
