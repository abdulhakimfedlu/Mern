  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <motion.div
          className={`absolute -top-4 -left-4 w-full h-full rounded-2xl opacity-10 ${highlight.accent === 'primary-gold' ? 'bg-primary-gold' : 'bg-primary-red'
            }`}
          animate={{
            rotate: [0, 5, 0, -5, 0],
      ...
      <div className="relative p-8 lg:p-12">
        ...
        >
          <motion.div
            className={`w-16 h-1 rounded-full ${highlight.accent === 'primary-gold' ? 'bg-primary-gold' : 'bg-primary-red'
              }`}
            animate={{
              scaleX: [1, 1.2, 1],
              opacity: [0.7, 1, 0.7],
          ...
          />
          <motion.div
            className={`w-3 h-3 rounded-full ${highlight.accent === 'primary-gold' ? 'bg-primary-gold' : 'bg-primary-red'
              }`}
            animate={{
              scale: [1, 1.5, 1],
              opacity: [0.5, 1, 0.5],
