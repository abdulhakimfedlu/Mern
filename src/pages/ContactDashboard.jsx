...
const ContactDashboard = () => {
    const [messages, setMessages] = useState([
        { id: 1, name: 'Abebe Kebede', email: 'abebe@example.com', subject: 'Private Event Inquiry', message: 'I would like to book the entire restaurant for a wedding anniversary on December 15th. Is it available?', date: '2023-11-25' },
        { id: 2, name: 'Sara Tesfaye', email: 'sara@example.com', subject: 'Menu Question', message: 'Do you offer gluten-free options for the main course? My husband has an allergy.', date: '2023-11-24' },
        { id: 3, name: 'Dawit Alemu', email: 'dawit@example.com', subject: 'Feedback', message: 'The service was excellent last night! Specifically want to commend our server, Tigist.', date: '2023-11-23' },
    ]);
