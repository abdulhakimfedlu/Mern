...
import { Plus, Search, Edit2, Trash2, Upload, Camera, Tag, FileText } from 'lucide-react';
import ConfirmationModal from '../components/ConfirmationModal';

const FoodItemsDashboard = () => {
    const [items, setItems] = useState([
        { id: 1, name: 'Truffle Risotto', category: 'Main Course', price: '450', description: 'Creamy arborio rice with black truffle oil and parmesan.', image: 'https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=500&h=500&fit=crop' },
        { id: 2, name: 'Beef Wellington', category: 'Main Course', price: '850', description: 'Tender beef fillet wrapped in puff pastry with mushroom duxelles.', image: 'https://images.unsplash.com/photo-1600891964092-4316c288032e?w=500&h=500&fit=crop' },
        { id: 3, name: 'Tiramisu', category: 'Desserts', price: '250', description: 'Classic Italian dessert with coffee-soaked ladyfingers and mascarpone cream.', image: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=500&h=500&fit=crop' },
    ]);
    ...
    const handleOpenModal = (item = null) => {
        if (item) {
            ...
            setCurrentItem(null);
            setFormData({ name: '', category: 'Main Course', price: '', description: '', image: null, imagePreview: '' });
        }
        setIsModalOpen(true);
    };
    ...
    const handleSubmit = (e) => {
        ...
        if (currentItem) {
            setItems(items.map(item => item.id === currentItem.id ? { ...itemData, id: item.id } : item));
        } else {
